...
%General object detection has the drawback of requiring a vast amount of data to be trained. Similar to few-shot learning, 
...
%Open vocabulary object detection, styleclip
...
\includegraphics[width=\textwidth]{fig/BRLF_plot_v2.pdf}
    ...
    \end{subfigure}
    % \includegraphics[width=0.7\columnwidth]{fig/0_seed.jpg}
    \caption{
...
%     \toprule
%          Method&FRCN-ft &FSRW & MetaDet & MetaRCNN & MPSR & DeFRCN & Ours  \\
%          \midrule 
%          mAP&31.2&32.3&33.9&37.4&42.3&55.9&1 \\
%          \bottomrule
%     \end{tabular}
%     \caption{COCO base $\rightarrow$ Pascal VOC novel set}
%     \label{tab:my_label}
% \end{table}
% {\bf Cross Domain} \lipsum[9]
    ...
    \begin{tabular}{c|c|c|cc|cc|cc}
        ...
        \hline
         \multirow{4}{*}{RISF} &  \XSolidBrush & \XSolidBrush  & 5.6&10.3&10.9&19.7&17.2&30.7 \\
          ...
          &  \Checkmark & \XSolidBrush  &7.9&15.0&14.2&26.0&19.3&34.3 \\% seed==1일때 다시해야함
...
\begin{figure}[h]
    ...
    % \end{subfigure}
    % \begin{subfigure}[]{0.45\textwidth}    \includegraphics[width=0.9\linewidth,height=0.8\textwidth]{fig/appendix_script_bar.pdf}
    % \end{subfigure}
    % \label{fig:cmclip}
