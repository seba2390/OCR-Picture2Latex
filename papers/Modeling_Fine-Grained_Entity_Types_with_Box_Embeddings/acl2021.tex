...
% Reduce space between paragraphs and equations.
...
%\todo{@Yasu: Greg added this, is this a good cite?}
...
%\greg{Briefly reference hyperbolic / order embeddings as well}
...
\begin{table*}[t]
	...
	\setlength{\tabcolsep}{4pt}
	%\hfill{}
	%\begin{tabular}{l c c c @{\hspace{3\tabcolsep}} c c c @{\hspace{3\tabcolsep}} c c c @{\hspace{3\tabcolsep}} c c c}
	\begin{tabular}{l c c c c c c c c c c c c c c c }
		...
		\midrule
		%\cmidrule(r){1-1} \cmidrule(r){2-5} \cmidrule(r){6-8} \cmidrule(r){9-11} \cmidrule{12-14}
...
%%%%%%%%%%%%% result table: OntoNotees, FIGER, BBN test %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand{\arraystretch}{1}
\begin{table*}[t]
	\centering
	\small
