...
% Title.
% ------
%\title{MODEL-FREE SAR DESPECKLING THROUGH CONVOLUTIONAL NEURAL NETWORKS}
...
%For these images, the usual hypothesis of fully developed speckle does not hold anymore,
%and most popular tools provide poor results.

%Developing specific models for all possible cases of interest is a challenging task, to say the least.
%Some authors propose flexible models, based on a mixture of distributions \cite{Cui2014, Li2016}.
%Others \cite{Bianchi2008, Gragnaniello2016} rely on a preliminary classification step to allow model switching.
...
%and operates on 40$\times$40 pixel image patches.
...
%In our experiments we used 26 co-registered multitemporal SAR images.
...
%\begin{table*}[t]
%	\centering
%	\caption{PSNR -- SSIM indexes arising from the despeckling of synthetic SAR images.}
%	\label{tab:sintetico}
%	\small
%	\begin{tabular}{ccccc}
%		\toprule
...
%		\midrule
%		Cameraman & 23.02 -- 0.661 & 24.37 -- 0.716 & 24.76 -- 0.750 & 26.15 -- 0.792\\
%		House     & 25.51 -- 0.651 & 25.75 -- 0.686 & 27.55 -- 0.751 & 28.60 -- 0.791\\
%		Peppers   & 23.85 -- 0.680 & 23.62 -- 0.716 & 24.92 -- 0.747 & 26.02 -- 0.793\\
%		%Starfish  & 21.13 -- 0.563 & 21.84 -- 0.609 & 22.71 -- 0.664 & 23.37 -- 0.702\\
%		%Butterfly & 22.76 -- 0.714 & 23.82 -- 0.752 & 24.48 -- 0.792 & 26.05 -- 0.841\\
%		Airplane  & 21.22 -- 0.533 & 21.83 -- 0.620 & 22.71 -- 0.672 & 23.93 -- 0.724\\
%		Parrot    & 21.88 -- 0.685 & 24.13 -- 0.732 & 24.17 -- 0.771 & 25.92 -- 0.805\\
%		Lena      & 26.64 -- 0.680 & 26.80 -- 0.714 & 27.85 -- 0.763 & 28.70 -- 0.800\\
%		%Barbara   & 24.08 -- 0.652 & 23.13 -- 0.631 & 25.37 -- 0.729 & 24.70 -- 0.718\\
%		Boat      & 24.22 -- 0.573 & 24.55 -- 0.602 & 25.43 -- 0.650 & 26.05 -- 0.675\\
%		\bottomrule
%	\end{tabular}
%\end{table*}
...
%\begin{figure}
%\centering
%\includegraphics[width=0.9\linewidth,trim={60px 180px 150px 180px},clip]{figs/train_test}
%\caption{A zoomed component of the COSMO-SkyMed image used for the numerical evaluation. The training data are marked in green, while the test images are indicated in blue. \label{fig:sar_setting}}
%\end{figure}
...
%		\centerline{\small PPB: \emph{25.28 -- 0.171}}\medskip
%	\end{minipage}
%	\hfill
%	\begin{minipage}[b]{0.19\linewidth}
%		\centering
%		\centerline{\includegraphics[width=\textwidth,trim={50px 50px 80px 160px},clip]{figs/sar2/nlsar}}
%		\centerline{\small NL-SAR: \emph{52.12 -- 0.065}}\medskip
%	\end{minipage}
%	\hfill
%	\begin{minipage}[b]{0.19\linewidth}
%		\centering
%		\centerline{\includegraphics[width=\textwidth,trim={50px 50px 80px 160px},clip]{figs/sar2/sar_bm3d}}
%		\centerline{\small SAR-BM3D: \emph{4.71 -- 0.511}}\medskip
%	\end{minipage}
%	\hfill
%	\begin{minipage}[b]{0.19\linewidth}
%		\centering
%		\centerline{\includegraphics[width=\textwidth,trim={50px 50px 80px 160px},clip]{figs/sar2/sar_cnn}}
%		\centerline{\small SAR-CNN: \emph{56.32 -- 0.182}}\medskip
%	\end{minipage}
%	
%	\begin{minipage}[b]{0.19\linewidth}
%		\centering
%		\centerline{\includegraphics[width=\textwidth,trim={50px 50px 80px 160px},clip]{figs/sar1/sar}}
%		\centerline{\small Noisy clip}\medskip
%	\end{minipage}
%	\hfill
%	\begin{minipage}[b]{0.19\linewidth}
%		\centering
%		\centerline{\includegraphics[width=\textwidth,trim={50px 50px 80px 160px},clip]{figs/sar1/ppb}}
%		\centerline{\small PPB: \emph{6.86 -- 0.159}}\medskip
%	\end{minipage}
%	\hfill
%	\begin{minipage}[b]{0.19\linewidth}
%		\centering
%		\centerline{\includegraphics[width=\textwidth,trim={50px 50px 80px 160px},clip]{figs/sar1/nlsar}}
%		\centerline{\small NL-SAR: \emph{8.64 -- 0.113}}\medskip
%	\end{minipage}
%	\hfill
%	\begin{minipage}[b]{0.19\linewidth}
%		\centering
%		\centerline{\includegraphics[width=\textwidth,trim={50px 50px 80px 160px},clip]{figs/sar1/sar_bm3d}}
%		\centerline{\small SAR-BM3D: \emph{2.67 -- 0.433}}\medskip
%	\end{minipage}
%	\hfill
%	\begin{minipage}[b]{0.19\linewidth}
%		\centering
%		\centerline{\includegraphics[width=\textwidth,trim={50px 50px 80px 160px},clip]{figs/sar1/sar_cnn}}
%		\centerline{\small SAR-CNN: \emph{6.93 -- 0.106}}\medskip
%	\end{minipage}
%	\vspace{-1em}
%	\caption{ENL -- $\alpha\beta$ indexes for the despeckling of a single-look COSMO-SkyMed multitemporal image. \label{fig:sar_results}}
%\end{figure*}
