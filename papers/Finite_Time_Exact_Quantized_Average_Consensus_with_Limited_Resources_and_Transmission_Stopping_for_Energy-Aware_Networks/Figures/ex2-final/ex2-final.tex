...
\ncarc[arcangle=20]{->}{S1}{S2}^{9}
\ncarc[arcangle=10]{->}{S2}{S1}^{7}
\ncarc[arcangle=-10]{->}{S3}{S1}%^{11}
\rput(1.15,8){11}
\ncarc[arcangle=0]{->}{S1}{S5}^{9}
\ncarc[arcangle=0]{->}{S2}{S5}^{6}
\ncarc[arcangle=0]{->}{S3}{S5}^{10}
\ncarc[arcangle=0]{->}{S4}{S5}^{3}
\ncarc[arcangle=0]{->}{S5}{S6}%^{14}
\rput(2.7,6.25){14}
\ncarc[arcangle=0]{->}{S5}{S7}%^{14}
\rput(5.3,6.25){14}
\ncarc[arcangle=10]{->}{S4}{S2}%^{4}
\rput(6.85,8){4}
\ncarc[arcangle=-10]{->}{S7}{S4}%^{7}
\rput(7.1,5.7){7}
\ncarc[arcangle=10]{->}{S7}{S6}^{7}
\ncarc[arcangle=10]{->}{S6}{S3}%^{21}
\rput(0.9,5.7){21}
