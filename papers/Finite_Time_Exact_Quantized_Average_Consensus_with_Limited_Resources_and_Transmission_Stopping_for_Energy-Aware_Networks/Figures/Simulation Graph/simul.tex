...
\ncarc[arcangle=10]{->}{S2}{S1}%^{1/2}
\ncarc[arcangle=10]{->}{S3}{S1}%^{0.55/3}
%\rput(0.7,8.2){0.55/3}
\ncarc[arcangle=0]{->}{S1}{S5}%^{1/2}
\ncarc[arcangle=0]{->}{S2}{S5}%^{1/4}
\ncarc[arcangle=0]{->}{S3}{S5}%^{0.55/3}
\ncarc[arcangle=0]{->}{S4}{S5}%^{0.55/1}
\ncarc[arcangle=0]{->}{S5}{S6}%^{1.9/2}
%\rput(2.5,6.25){1.9/2}
\ncarc[arcangle=0]{->}{S5}{S7}%^{1.9/3}
%\rput(5.5,6.25){1.9/3}
\ncarc[arcangle=-10]{->}{S4}{S2}%^{0.55/2}
%\rput(7.3,8.2){0.55/2}
\ncarc[arcangle=-10]{->}{S7}{S4}%^{0.55/3}
%\rput(7.3,5.7){0.55/3}
\ncarc[arcangle=10]{->}{S7}{S6}%^{0.55/2}
\ncarc[arcangle=10]{->}{S6}{S3}%^{1.9/2}
%\rput(0.8,5.7){1.9/2}
