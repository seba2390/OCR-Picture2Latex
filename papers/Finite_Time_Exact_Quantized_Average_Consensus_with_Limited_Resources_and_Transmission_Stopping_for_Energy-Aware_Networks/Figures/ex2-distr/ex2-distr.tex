...
\ncarc[arcangle=10]{->}{S3}{S1}%^{7-3}
\rput(1.15,8){7-3}
\ncarc[arcangle=0]{->}{S1}{S5}^{7}
\ncarc[arcangle=0]{->}{S2}{S5}^{7}
\ncarc[arcangle=0]{->}{S3}{S5}^{7-3}
\ncarc[arcangle=0]{->}{S4}{S5}^{7-3}
\ncarc[arcangle=0]{->}{S5}{S6}%^{7+7}
\rput(2.7,6.25){7+7}
\ncarc[arcangle=0]{->}{S5}{S7}%^{7+7}
\rput(5.3,6.25){7+7}
\ncarc[arcangle=10]{->}{S4}{S2}%^{7-3}
\rput(6.85,8){7-3}
\ncarc[arcangle=-10]{->}{S7}{S4}%^{7-3}
\rput(7.1,5.7){7-3}
\ncarc[arcangle=10]{->}{S7}{S6}^{7-3}
\ncarc[arcangle=10]{->}{S6}{S3}%^{7+7}
\rput(0.9,5.7){7+7}
