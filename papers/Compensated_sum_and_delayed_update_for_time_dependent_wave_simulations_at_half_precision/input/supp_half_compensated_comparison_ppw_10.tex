...
% \renewcommand{\folderPath}{\string"./input/supp_half_compensated_comparison_ppw_10/\string"}
...
\label{comparison_V_half_compensated_segments_ppw_10}
\end{figure}
%
\end{minipage}
%
...
\label{comparison_E_half_compensated_segments_ppw_10}
\end{figure}
%
\end{minipage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
