...
\pgfplotstableread{data/drillspomcpow.dat}{\firsttable}%
    \pgfplotstablegetrowsof{data/drillspomcpow.dat}%
...
\pgfmathsetmacro{\Zceiling}{2/\scale}% contain the values of z
\pgfmathsetmacro{\epsZ}{0.5} % Z-min epsilon
\ifdefined\SHOWMAP%
    \pgfplotstableread{data/mapstdpomcpow.dat}{\maptable}%
        \pgfplotstablegetrowsof{data/mapstdpomcpow.dat}%
...
\fi%
\pgfplotstableread{data/decisionspomcpow.dat}{\decisiontable}%
