...
\texttt{\textbackslash Dmp} & \Dmp & \texttt{\textbackslash Dstar} & \Dstar & \texttt{\textbackslash Dstarb} & \Dstarb \\
\texttt{\textbackslash Dstarz} & \Dstarz & \texttt{\textbackslash Dstarzb} & \Dstarzb & \texttt{\textbackslash theDstarz} & \theDstarz \\
\texttt{\textbackslash theDstarzb} & \theDstarzb & \texttt{\textbackslash Dstarp} & \Dstarp & \texttt{\textbackslash Dstarm} & \Dstarm \\
\texttt{\textbackslash Dstarpm} & \Dstarpm & \texttt{\textbackslash Dstarmp} & \Dstarmp & \texttt{\textbackslash theDstarp} & \theDstarp \\
\texttt{\textbackslash theDstarm} & \theDstarm & \texttt{\textbackslash theDstarpm} & \theDstarpm & \texttt{\textbackslash theDstarmp} & \theDstarmp \\
...
\texttt{\textbackslash Dssmp} & \Dssmp &  \\
\end{tabular*}
