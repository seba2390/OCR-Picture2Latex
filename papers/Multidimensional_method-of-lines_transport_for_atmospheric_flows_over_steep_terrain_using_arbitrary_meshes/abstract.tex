...
Reconstruction calculations depend upon the mesh only, needing just one vector multiply per face per \revtwo{time-stage} irrespective of the velocity field.
