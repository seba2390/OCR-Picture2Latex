\documentclass[aps,pre,amsfonts,amssymb,amsmath,twocolumn, superscriptaddress]{revtex4-1}
\usepackage{color}
\usepackage{environ}
\usepackage{graphicx}
\usepackage{hyperref}
...
\renewcommand{\beginmarkversion}{\begingroup\renewcommand{\notcolor}{magenta}\color{red}}
\renewcommand{\endmarkversion}{\endgroup}
\excludeversion{checked}
\markversion{detail}
% \usepackage[onehalfspacing]{setspace} # this gives a warning in overleaf
% \linenumbers
...
% set size of some figure panels, same for all subpanels
...
%\newcommand\del{\bgroup\markoverwith
%{\textcolor{red}{\rule[0.5ex]{2pt}{0.8pt}}}\ULon}
\begin{document}
%\onecolumn
%\firstpage{1}

%\title[Phase defect framework for the analysis of cardiac arrhythmia patterns]{A phase defect framework for the analysis of cardiac arrhythmia patterns} 
...
%\maketitle
%\title{Two regimes of filament tension for meandering scroll waves}
\title{A phase defect framework for the analysis of cardiac arrhythmia patterns} 

\author{Louise Arno}
\affiliation{KULeuven Campus KULAK, Department of Mathematics, Kortrijk, Belgium }
...
\author{Maarten Vanmarcke}
\affiliation{KULeuven Campus KULAK, Department of Mathematics, Kortrijk, Belgium }

\author{Elena G. Tolkacheva}
\affiliation{ University of Minnesota, Biomedical Engineering Department, Minneapolis, MN 55455, Minnesota, USA}
...
\cite{Gray:1998} also developed the concept of phase analysis to identify structures in the excitation patterns in the heart. \del{ In brief, the activation phase of a point in the medium can be found by plotting two well-chosen linearly independent observables $V(\vec{r},t)$ and $R(\vec{r},t)$ in the medium against each other. In a cardiac context, $V(\vec{r},t)$ is usually the local transmembrane voltage or optical intensity in optical mapping experiments. The variable $R$ is in experiments typically a time-delayed or convoluted version of $V$, while in simulations another state variable can be used \cite{Gray:1998, Bray:2002, Clayton:2005}. }
...
\del{Here and below, we measure $\phiact$ in radians. }
\begin{figure*}
    \centering
   \raisebox{3cm}{\textbf{A}} \includegraphics[trim={7cm 0.3cm 6cm 1.2cm},clip, height = 3.5cm]{figures/AP_U_t_150.eps}
   \raisebox{3cm}{\textbf{B}} \includegraphics[trim={1cm 0.3cm 0cm 1.3cm},clip, height = 3.cm]{figures/AP_Phase_space_t_150_vs3.eps}
     \raisebox{3cm}{\textbf{C}} \includegraphics[trim={8cm 0.3cm 8cm 1.2cm},clip, height = 3.5cm]{figures/AP_phi_act_t_150.eps} \\
    ...
    \label{fig:classic}
\end{figure*}
\del{From its definition, it follows that phase is only defined up to an integer value of $2 \pi$, i.e. phases that differ $2\pi$ are denoting the same state. }
\del{For example, if a single action potential propagates through the medium, phase changes over $\pm 2\pi$ to attain the resting state again. If necessary, one can redefine $R$ as $-R$ to make this phase difference equal to $+2\pi$. }
...
\begin{figure*}
    \centering
\raisebox{2.5cm}{\textbf{A}} 
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip,height= 2.7cm]{figures/AP_phi_arr_t_20.jpg}
...
\raisebox{2.5cm}{\textbf{B}} 
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, height= 2.7cm]{figures/AP_phi_arr_t_38.jpg}
\raisebox{2.5cm}{\textbf{C}} 
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, height= 2.7cm]{figures/AP_phi_arr_t_57.jpg}
\raisebox{2.5cm}{\textbf{D}} 
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, height= 2.7cm]{figures/AP_phi_arr_t_150.jpg}
...
\includegraphics[trim=1.5cm 1cm 0.5cm 0.5cm, clip,height=5cm]{figures/Hren_BO_fil_21.eps}
\raisebox{4cm}{\textbf{B}} 
\includegraphics[trim=1.5cm 1cm 2.5cm 1.5cm, clip,height=5cm]{figures/Hren_BO_PDS.eps}
\caption{
...
% \centering
% \includegraphics[width=\textwidth]{figures/fig4_semirotor_integral2244plus_Louise.eps}
...
%We include supplementary videos showing the time evolution of PDLs, PSs and wavefronts in the optical mapping experiments, as in Fig. \ref{fig:experiments}. 
...
%\input{Phase_defects_arxiv.bbl}

\bibliography{Phase_defects_arxiv}
