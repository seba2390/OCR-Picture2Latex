...
\begin{figure}
    \centering
   \raisebox{3cm}{\textbf{A}} \includegraphics[trim={7cm 0.3cm 6cm 1.2cm},clip,width=0.28\textwidth]{figures/AP_U_t_150.eps}
   \raisebox{3cm}{\textbf{B}} \includegraphics[trim={1cm 0.3cm 0cm 1.3cm},clip, width=0.28\textwidth]{figures/AP_Phase_space_t_150_vs3.eps}
     \raisebox{3cm}{\textbf{C}} \includegraphics[trim={8cm 0.3cm 8cm 1.2cm},clip,width=0.28\textwidth]{figures/AP_phi_act_t_150.eps} \\
...
\begin{figure}
 \begin{tabular}{ c c}
\raisebox{3.1cm}{\textbf{A}}  &  \includegraphics[ trim={8cm 0cm 10.5cm 1.2cm},clip,width=0.24\textwidth]{BO_U_t_80.eps}
 \includegraphics[ trim={8cm 0cm 10.5cm 1.2cm},clip,width=0.24\textwidth]{BO_U_t_100.eps}
     \includegraphics[trim={8cm 0cm 10cm 1.2cm},clip, width=0.24\textwidth]{BO_U_t_130_PS_22.eps}
    \includegraphics[trim={8cm 0cm 10cm 1.2cm},clip, width=0.24\textwidth]{BO_U_t_130_PS_2244.eps} 
 \\
\raisebox{4.1cm}{\textbf{B}}  &  \includegraphics[trim={8cm 0cm 8cm 1.2cm},clip, width=0.33\textwidth]{figures/FK_u_ifr_155.eps}
   \includegraphics[trim={8cm 0cm 13.5cm 1.2cm},clip,width=0.32\textwidth]{figures/phi_act_2D.eps}
  % \includegraphics[trim={8cm 0.3cm 14cm 1.2cm},clip,width=0.24\textwidth]{figures/phi_act_2D.eps}
    \includegraphics[trim={8cm 0cm 9.5cm 1.2cm},clip,width=0.31\textwidth]{figures/FK_AT_cont_combi_ifr_155_vs4.eps}\\
    \raisebox{5cm}{\textbf{C}}&
    \includegraphics[trim={4cm 9.5cm 3.9cm 1cm}, clip, width=0.97\textwidth]{u_t_380_382_384_386_389_vs2.eps}
...
\begin{figure}
    \centering
    \includegraphics[width=0.25\textwidth]{Kuklik_22.eps}
    \includegraphics[width=0.25\textwidth]{ring_4x4.eps}
...
\begin{figure}
    ...
    \includegraphics[trim={12cm 0cm 18.5cm 0.5cm},clip, width=0.21\textwidth]{figures/u_t_180_vs_AT.eps}
    \includegraphics[trim={12cm 0cm 18.5cm 0.5cm},clip, width=0.21\textwidth]{figures/u_t_185_vs_AT.eps}
    \includegraphics[trim={12cm 0cm 18.5cm 0.5cm},clip, width=0.21\textwidth]{figures/u_t_190_vs_AT.eps}
    \includegraphics[trim={12cm 0cm 8cm 0.5cm},clip, width=0.27\textwidth]{figures/u_t_195_vs_AT.eps} \\
    
         \raisebox{3cm}{\textbf{B}} 
       \includegraphics[trim={12cm 0cm 18.5cm 0.5cm},clip, width=0.21\textwidth]{figures/phi_act_t_180_vs_AT.eps}
    \includegraphics[trim={12cm 0cm 18.5cm 0.5cm},clip, width=0.21\textwidth]{figures/phi_act_t_185_vs_AT.eps}
    \includegraphics[trim={12cm 0cm 18.5cm 0.5cm},clip,width=0.21\textwidth]{figures/phi_act_t_190_vs_AT.eps}
    \includegraphics[trim={12cm 0cm 8cm 0.5cm},clip,width=0.27\textwidth]{figures/phi_act_t_195_vs_AT.eps} \\
    
    \raisebox{3cm}{\textbf{C}} 
    \includegraphics[trim={12cm 0cm 19cm 0cm},clip, width=0.21\textwidth]{figures/grad_phi_act_t_180.eps}
    \includegraphics[trim={12cm 0cm 19cm 0.5cm},clip, width=0.21\textwidth]{figures/grad_phi_act_t_185.eps}
    \includegraphics[trim={12cm 0cm 19.2cm 0cm},clip, width=0.21\textwidth]{figures/grad_phi_act_t_190.eps}
    \includegraphics[trim={12cm 0cm 7.9cm 0.5cm},clip, width=0.27\textwidth]{figures/grad_phi_act_t_195.eps}\\
...
\end{figure}
 ...
 \begin{figure}
     \centering
     \includegraphics[width=0.3\textwidth]{threephases.eps}
...
\begin{figure}
    \centering
\raisebox{5.5cm}{\textbf{A}}    \includegraphics[trim={8cm 0cm 7.5cm 1cm},clip,width=0.45\textwidth]{figures/phi_arr_wrt_t_elapsed_font_40_vs2.eps}
\raisebox{5.5cm}{\textbf{B}}    \includegraphics[trim={8cm 0cm 7.5cm 1.5cm},clip,width=0.45\textwidth]{figures/phi_act_wrt_phi_arr_step_30_font_40_vs2.eps} \\
\raisebox{5.5cm}{\textbf{C}}    \includegraphics[trim={8cm 0cm 7.5cm 1.2cm},clip,width=0.45\textwidth]{figures/FK_phi_arr_zoom_vs2.eps}
\raisebox{5.5cm}{\textbf{D}}    \includegraphics[trim={8cm 0cm 7cm 1.5cm},clip,width=0.45\textwidth]{figures/FK_grad_phi_arr_font_40_vs2.eps}
...
\begin{figure}
     ...
     \includegraphics[trim={12cm 0cm 18.5cm 0.5cm},clip,width=0.21\textwidth ]{figures/phi_arr_t_180_vs_AT.eps}
    \includegraphics[trim={12cm 0cm 18.5cm 0.5cm},clip,width=0.21\textwidth]{figures/phi_arr_t_185_vs_AT.eps}
    \includegraphics[trim={12cm 0cm 18.5cm 0.5cm},clip, width=0.21\textwidth]{figures/phi_arr_t_190_vs_AT.eps}
    \includegraphics[trim={12cm 0cm 8cm 0.5cm},clip, width=0.27\textwidth]{figures/phi_arr_t_195_vs_AT.eps} \\
    
    \raisebox{2.5cm}{\textbf{B}} 
    \includegraphics[trim={12cm 0cm 19cm 0.5cm},clip,width=0.21\textwidth]{figures/grad_phi_arr_t_180.eps}
    \includegraphics[trim={12cm 0cm 19cm 0.5cm},clip,width=0.21\textwidth]{figures/grad_phi_arr_t_185.eps}
    \includegraphics[trim={12cm 0cm 19cm 0.5cm},clip,width=0.21\textwidth]{figures/grad_phi_arr_t_190.eps}
    \includegraphics[trim={12cm 0cm 8.cm 0.5cm},clip, width=0.27\textwidth]{figures/grad_phi_arr_t_195.eps}
...
\includegraphics[width=\fs\textwidth]{figures/AP_Riemann2.eps}&
\includegraphics[width=\fs\textwidth]{figures/mathPS2.eps}&
\includegraphics[width=\fs\textwidth]{figures/FK_Riemann2.eps} &
\includegraphics[width=\fs\textwidth]{figures/mathPDL2.eps} \\
%\STAB{\rotatebox[origin=c]{90}{complex analysis}} & 
 \includegraphics[width=\fs\textwidth]{figures/AP_Riemann.eps}&
  \includegraphics[width=\fs\textwidth]{figures/mathPS3.eps}&
  \includegraphics[width=\fs\textwidth]{figures/FK_Riemann.eps} &
  \includegraphics[width=\fs\textwidth]{figures/mathPDL3.eps} \\
  \multicolumn{4}{c}{
\includegraphics[width=0.45\textwidth]{figures/cbar_hsvblue.eps}
}
\end{tabular}
...
\begin{figure}
    \centering
\raisebox{2.5cm}{\textbf{A}}    \includegraphics[trim={7cm 0cm 9cm 1cm},clip,width=0.2 \textwidth]{figures/BO_t_130_2D_pha_act_vs_2.eps}
%\raisebox{3cm}{\textbf{B}}  
    \includegraphics[trim={1cm 0cm 0cm 0cm},clip,width=0.23 \textwidth]{BO_t_130_3D_pha_act_vs_4.eps}
\raisebox{2.5cm}{\textbf{B}}    \includegraphics[trim={7cm 0cm 9cm 1cm},clip,width=0.2 \textwidth]{BO_t_130_2D_pha_arr.eps}
% \raisebox{3cm}{\textbf{D}}  
    \includegraphics[trim={1cm 0cm 0cm 0cm},clip,width=0.23 \textwidth]{BO_t_130_3D_pha_arr_vs3.eps} 
...
\begin{figure}
    \centering
\raisebox{2.5cm}{\textbf{A}} 
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip,width=0.21\textwidth]{figures/AP_phi_arr_t_20.eps}
%\includegraphics[trim=3cm 0.5cm 1.5cm 1cm, clip,width=0.3\textwidth]{figures/AP_S12_PDL.eps}
% \raisebox{2cm}{\textbf{B}} \includegraphics[width=0.15\textwidth]{figures/AP_S12_PS.eps}
%\raisebox{2cm}{\textbf{B}} \includegraphics[trim=3cm 1cm 1cm 1cm, clip,width=0.2\textwidth]{Activation_Phase_AP_start_figure_8_sims_2001_black_final.eps}\\
\raisebox{2.5cm}{\textbf{B}} 
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, width=0.21\textwidth]{figures/AP_phi_arr_t_38.eps}
\raisebox{2.5cm}{\textbf{C}} 
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, width=0.21\textwidth]{figures/AP_phi_arr_t_57.eps}
\raisebox{2.5cm}{\textbf{D}} 
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, width=0.21\textwidth]{figures/AP_phi_arr_t_150.eps}
...
\includegraphics[trim={1cm 0.3cm 0cm 1cm},clip, width=0.28\textwidth]{figures/break_up_3D_ifr_30.eps}
\raisebox{2cm}{\textbf{B}} 
\includegraphics[trim={1cm 0.3cm 0cm 1cm},clip, width=0.28\textwidth]{figures/break_up_3D_ifr_35.eps}
\raisebox{2cm}{\textbf{C}} 
\includegraphics[trim={1cm 0.3cm 0cm 1cm},clip, width=0.28\textwidth]{figures/break_up_3D_ifr_40.eps}
\\ 
\includegraphics[trim={8cm 0.3cm 9cm 1cm},clip,width=0.28\textwidth]{figures/break_up_u_ifr_30.eps}
\includegraphics[trim={8cm 0.3cm 9cm 1cm},clip, width=0.28\textwidth]{figures/break_up_u_ifr_35.eps}
\includegraphics[trim={8cm 0.3cm 9cm 1cm},clip, width=0.28\textwidth]{figures/break_up_u_ifr_40.eps}
\\
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, width=0.28\textwidth]{figures/break_up_pha_arr_ifr_30.eps}
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, width=0.28\textwidth]{figures/break_up_pha_arr_ifr_35.eps}
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, width=0.28\textwidth]{figures/break_up_pha_arr_ifr_40.eps}
\\ 
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, width=0.28\textwidth]{figures/break_up_pha_act_ifr_30.eps}
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, width=0.28\textwidth]{figures/break_up_pha_act_ifr_35.eps}
\includegraphics[trim={8cm 0.3cm 10cm 1cm},clip, width=0.28\textwidth]{figures/break_up_pha_act_ifr_40.eps}
\\
\includegraphics[trim={1cm 0.3cm 0cm 1cm},clip, width=0.28\textwidth]{figures/break_up_3D_PDS_ifr_30.eps}
\hspace{0.3cm}
\includegraphics[trim={1cm 0.3cm 0cm 1cm},clip, width=0.28\textwidth]{figures/break_up_3D_PDS_ifr_35.eps}
\hspace{0.3cm}
\includegraphics[trim={1cm 0.3cm 0cm 1cm},clip, width=0.28\textwidth]{figures/break_up_3D_PDS_ifr_40.eps}
...
\includegraphics[trim=1.5cm 1cm 0.5cm 0.5cm, clip,width=0.4\textwidth]{figures/Hren_BO_fil_21.eps}
\raisebox{4cm}{\textbf{B}} 
\includegraphics[trim=1.5cm 1cm 2.5cm 1.5cm, clip,width=0.4\textwidth]{figures/Hren_BO_PDS.eps}
\caption{
...
\centering
\includegraphics[width=0.8\textwidth]{figures/OM_panoramic_all.eps}
...
\begin{figure}[htp]
\centering
%\raisebox{4cm}{\textbf{A}} \includegraphics[height=5cm]{figures/WF_PDL_PS_in_t.eps}
%\raisebox{4cm}{\textbf{B}} 
\includegraphics[height=5cm]{figures/VT1_PSvsPDL.eps}
