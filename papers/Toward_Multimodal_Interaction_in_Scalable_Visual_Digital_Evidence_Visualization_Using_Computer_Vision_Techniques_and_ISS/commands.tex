...
\newcommand{\xd}[1]{Definition~\ref{#1}}
\newcommand{\xdp}[1]{Definition~\ref{#1}, \xp{#1}}
\newcommand{\xP}[1]{Part~\ref{#1}}
\newcommand{\xm}[1]{item~\ref{#1}}
\newcommand{\xpar}[1]{\S~\ref{#1}}
\newcommand{\xparp}[1]{\S~\ref{#1}, \xp{#1}}
...
\newcommand{\ihtml}{{\langfontstyle{iHTML}\index{iHTML}}}
...
\newcommand{\dimtag}{$\langle\textit{dimension}:\textit{tag}\rangle$}

\newcommand{\foil}{FOIL\index{FOIL}\index{Logic!Intensional!First-order}}
...
\newcommand{\olucidop}[1]{\textbf{\texttt{\textmd{\textsc{#1}}}}}
\newcommand{\lucidop}[1]{\textbf{\texttt{#1}}}
\newcommand{\molucidop}[1]{\mathrm{\;}\textbf{\texttt{\textmd{\textsc{#1}}}}\mathrm{\;}}
\newcommand{\mlucidop}[1]{\textbf{\texttt{#1}}}
...
\newcommand{\bpel}{BPEL\index{BPEL}\index{BPEL}\index{Web Services!BPEL}}
...
\fbox{\begin{minipage}[b]{.9\textwidth}
\textbf{#1}
...
\newcommand{\initcontext}[2]{\mathcal{D}_{0},\mathcal{P}_{0} \vdash #1 : #2}
...
\def\Latw{\index{a@{\texttt{\char64}}}\;\texttt{\char64}_w\;}
\def\LSat{\index{a@{\texttt{\char64}}}\texttt{\char64}}
\def\Lhash{\index{a@{\texttt{\char35}}}\texttt{\char35}}
\def\Ldot{\index{a@{\texttt{\textbf{.}}}}\texttt{\textbf{.}}}
