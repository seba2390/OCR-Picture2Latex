...
\newcommand{\bv}{\ensuremath{\underline{b}}}
...
% \newcommand{\vv}{\vec{{v}}}
% \newcommand{\av}{\vec{{a}}}
% \newcommand{\wv}{\ensuremath{\vec{w}}}
% \newcommand{\xv}{\ensuremath{\vec{x}}}
% \newcommand{\yv}{\ensuremath{\vec{y}}}
% \newcommand{\zv}{\ensuremath{\vec{z}}}
% \newcommand{\bv}{\ensuremath{\vec{b}}}
% \newcommand{\ptree}{\ensuremath{p_{\mathrm{tree}}}}
% \newcommand{\bve}{\ensuremath{\overset{\stackrel{\sim}{\rightharpoondown}}{b}}}
% \newcommand{\bve}{\ensuremath{\dot{\bv}}}

% \newcommand{\oset}[2]{%
%   {\mathop{#2}\limits^{\vbox to -.5\ex@{\kern-\tw@\ex@
%     \hbox{\scriptsize #1}\vss}}}}
% \newcommand{\bve}{\ensuremath{\stackrel{\mathclap{\mbox{\leadsto}}}{b}}}

% \newcommand{\bve}{\ensuremath{\overset{{\mathclap{~}}}{\raisebox{0pt}[0.75\height]{$b$}}}}
% \newcommand{\bve}{\accentset{\leadsto}{\raisebox{0pt}[0.85\height]{\ensuremath{b}}}}
% \newcommand{\bve}{\accentset{\simeq}{b}}
% \newcommand{\bve}{\accentset{\Rightarrow}{b}}
% \newcommand{\bve}{\accentset{\leadsto}{b}}
% \newcommand{\bve}{\tilde{\raisebox{0pt}[0.85\height]{\ensuremath{\vec{b}}}}}
