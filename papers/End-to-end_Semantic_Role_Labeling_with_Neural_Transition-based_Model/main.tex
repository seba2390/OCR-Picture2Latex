...
%  \bm{x}_i = [ \bm{v}^w_i ; \tilde{\bm{v}}^w_i ]
% \end{equation}
...
\cmidrule(r){2-5}\cmidrule(r){6-10} %\cmidrule(r){10-10}
% \specialrule{0em}{0pt}{0pt}
& \multicolumn{3}{c}{ Arg.}& Prd. &  \multicolumn{3}{c}{ Arg.}& Prd. &  \multicolumn{1}{l}{\multirow{2}{*}{Decode}}\\
...
% We re-implement all the graph-based baselines by their released codes.
