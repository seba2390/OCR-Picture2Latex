...
%% Accompanies image file 'diagf0rho.pdf' (pdf, eps, ps)
%%
...
\begingroup%
  ...
  \begin{picture}(1,0.51612903)%
    \put(0,0){\includegraphics[width=\unitlength,page=1]{diagf0rho.pdf}}%
    ...
    %\put(0,0){\includegraphics[width=\unitlength,page=2]{diagf0rho.pdf}}%
  \end{picture}%
\endgroup%
