...
\title{IJCAI--22 Example on typesetting multiple authors}
...
Given a source sentence, neural machine translation (NMT) models \cite{1} are trained to predict conditional probability distributions for candidate translations . In practice, it is desirable to output a single sentence, not a distribution. Therefore, a decision rule is required to rank the candidate translations and select the ‘preferred’ one.
