...
\label{tab:ns}
\end{table*}
%%%% NEW VALUES: 0.999 1 0.997 -4.95 x 10^-5; 5 x 10^-4, 9 x 10^-4, 1 x 10^-3, 1 x 10^-7; 0.977 1.000 0.366 0.348
% 1.000 1 0.999 -5.12x10^-5 -0.0022; 7 x 10^-4, 6 x 10^-4, 1 x 10^-3, 6 x 10^-7, 3 x 10^-6; 0.995 1 0.0452 0.0042 0.0044
