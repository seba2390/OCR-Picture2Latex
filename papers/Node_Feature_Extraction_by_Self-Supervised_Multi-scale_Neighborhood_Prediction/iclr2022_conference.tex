...
Throughout the work, we focus on raw texts as these are the most common data used for large-scale graph benchmarking. %raw node attribute format in graph learning. 
...
%Our theoretical analysis also verifies the benefits of using XR-Transformers for our neighborhood prediction task.
%, which further improve the understanding of these advanced methods in XMC problems. 
...
%We relegate this generalization to future works. 
%Inspired by the recent success of self-supervised learning in GNNs, we propose a novel framework that allows the language models to be benefited from the correlations between raw text and graph structure (Figure~\ref{fig:pipelines}). 
...
%It not only verifies usefulness of those components in XR-Transformer for our neighborhood prediction task, but also improve our understanding to XR-Transformer and the XMC problem in the graph learning perspective. 
...
%Since we have built a connection between the XMC problem and graph learning, 
...
% 	\Eli{This is actually not rigorous. Should I say it's informal here and write it rigorously in the appendix?}
\end{theorem}
...
% {\color{red}(Cho: Maybe reorganize this section. Currently the experimental descriptions of ablation study and results of ablation study are seperated, making it harder to pass. I suggest the following structure: Mention the dataset and experimental settings (the first two paragraphs in the current version), and then Section 5.1 show the main experiments (performance boost by GIANT); Section 5.2 ablation study (both exp setting and results))} \Eli{Done.}
\begin{table}[t!]
...
% \toprule
% \multicolumn{1}{}{}  & ogbn-arxiv    & MLP                & GraphSAGE          & RevGAT             & RevGAT+SelfKD      \\ \midrule
% \multicolumn{1}{c}{\multirow{2}{*}{$X$}}         & OGB-feat$^\dagger$       & 55.50 ± 0.23          & {\ul 71.49 ± 0.27 }   & {\ul 74.02 ± 0.18}    & {\ul 74.26 ± 0.17}    \\
% \multicolumn{1}{c}{} & BERT$^\star$          & {\ul 62.91 ± 0.60} & 70.97 ± 0.33       & 73.59 ± 0.10       & 73.55 ± 0.41       \\ \midrule
% \multicolumn{1}{c}{\multirow{8}{*}{$X^\prime$}}        & OGB-feat+GZ    & {\ul 70.95 ± 0.38}    & 71.41 ± 0.09          & 72.42 ± 0.16          & 72.50 ± 0.08          \\
% \multicolumn{1}{c}{} & BERT$^\star$+GZ       & 70.46 ± 0.21       & 71.24 ± 0.19       & 72.33 ± 0.06       & 72.30 ± 0.20       \\
% \multicolumn{1}{c}{} & OGB-feat+DGI  & 56.02 ± 0.16       & 71.72 ± 0.26       & 73.48 ± 0.14       & 73.90 ± 0.26       \\
% \multicolumn{1}{c}{} & BERT$^\star$+DGI      & 59.42 ± 0.38       & 72.15 ± 0.06       & 73.24 ± 0.25       & 73.60 ± 0.21       \\
% \multicolumn{1}{c}{} & OGB-feat+GAE  & 56.47 ± 0.08       & 72.00 ± 0.27       & 73.70 ± 0.28       & 74.06 ± 0.10       \\
% \multicolumn{1}{c}{} & BERT$^\star$+GAE     & 62.11 ± 0.32       & 72.72 ± 0.17       & {\ul 74.26 ± 0.20} & {\ul 74.48 ± 0.15} \\ 
% \multicolumn{1}{c}{} & OGB-feat+VGAE & 56.70 ± 0.20       & 72.04 ± 0.29       & 73.59 ± 0.17       & 73.95 ± 0.09       \\
% \multicolumn{1}{c}{} & BERT$^\star$+VGAE  & 62.48 ± 0.14       & {\ul 72.92 ± 0.02} & 74.21 ± 0.01       & 74.44 ± 0.09       \\    \midrule

% \multicolumn{1}{c}{\multirow{5}{*}{$\tilde{X}$}} & BERT+LP        & 67.33 ± 0.54          & 66.61 ± 2.86          & 75.50 ± 0.11          & 75.75 ± 0.04          \\ \cmidrule(l){2-6} 
% \multicolumn{1}{c}{} & no TFIDF+no PIFA  & 69.33 ± 0.19 & 73.41 ± 0.34 & 74.95 ± 0.07 & 75.16 ± 0.06  \\
% \multicolumn{1}{c}{} & no TFIDF+PIFA   & 72.74 ± 0.17 & 74.43 ± 0.20 & 75.88 ± 0.05 & 76.06 ± 0.02  \\
% \multicolumn{1}{c}{} & TFIDF+no PIFA      & 71.74 ± 0.15 & 74.09 ± 0.33 & 75.56 ± 0.09 & 75.85 ± 0.05  \\
% \multicolumn{1}{c}{}                             & GIANT-XRT & \textbf{73.08 ± 0.06} & \textbf{74.59 ± 0.28} & \textbf{75.96 ± 0.09} & \textbf{76.12 ± 0.16} \\ \bottomrule
% % \multicolumn{1}{c}{$\tilde{X}$} & GIANT-XRT & \textbf{73.08 ± 0.06} & \textbf{74.59 ± 0.28} & \textbf{75.96 ± 0.09} & \textbf{76.12 ± 0.16} \\ \bottomrule
% \end{tabular}
\vspace{-0.2cm}
\end{table}
...
% \textcolor{orange}{add more description.}
% \textcolor{red}{we should at least have the number of nodes here, and some running times to illustrate scalability; and then mention the performance improvement.}
...
% \begin{table}[t!]
% \setlength{\tabcolsep}{2.5pt}
% \caption{Ablation study on ogbn-arxiv. Mean accuracy ($\%$) $\pm$ one standard deviation. Boldface letters indicate the best performance for each downstream models.}
% \label{tab:ogbn-arxiv_albation}
% \centering
% \begin{tabular}{@{}cccccc@{}}
% \toprule
%                       & ogbn-arxiv         & MLP          & GraphSAGE    & RevGAT       & RevGAT+SelfKD \\ \midrule
%                       & Best of $X$        & 62.91 ± 0.60 & 71.49 ± 0.27 & 74.02 ± 0.18 & 74.26 ± 0.17  \\
%                       & Best of $X^\prime$ & 70.95 ± 0.38 & 72.92 ± 0.02 & 74.26 ± 0.20 & 74.48 ± 0.15  \\ \midrule
% \multicolumn{1}{c}{\multirow{5}{*}{$\tilde{X}$}} & BERT+LP        & 67.33 ± 0.54          & 66.61 ± 2.86          & 75.50 ± 0.11          & 75.75 ± 0.04          \\ \cmidrule(l){2-6} 
% \multicolumn{1}{c}{} & no TFIDF+no PIFA  & 69.33 ± 0.19 & 73.41 ± 0.34 & 74.95 ± 0.07 & 75.16 ± 0.06  \\
% \multicolumn{1}{c}{} & no TFIDF+PIFA   & 72.74 ± 0.17 & 74.43 ± 0.20 & 75.88 ± 0.05 & 76.06 ± 0.02  \\
% \multicolumn{1}{c}{} & TFIDF+no PIFA      & 71.74 ± 0.15 & 74.09 ± 0.33 & 75.56 ± 0.09 & 75.85 ± 0.05  \\
...
% \begin{table}[t!]
% \setlength{\tabcolsep}{2.5pt}
% \caption{Ablation study on ogbn-products. Mean accuracy ($\%$) $\pm$ one standard deviation. Boldface letters indicate the best performance for each downstream models.}
% \label{tab:ogbn-products_albation}
% \centering
% \begin{tabular}{@{}lcccccc@{}}
% \toprule
%  & ogbn-products      & MLP          & GraphSAINT   & SAGN-0     & SAGN-1     & SAGN-2     \\ \midrule
%  & Best of $X$        & 61.06 ± 0.08 & 79.55 ± 0.85 & 83.38 ± 0.17 & 84.18 ± 0.14 & 84.28 ± 0.14 \\
%  & Best of $X^\prime$ & 78.81 ± 0.25 & 82.80 ± 0.11 & 83.78 ± 0.08 & 84.30 ± 0.06 & 84.42 ± 0.04 \\ \midrule
% \multirow{5}{*}{$\tilde{X}$} & BERT+LP        & 73.83 ± 0.06          & 81.66 ± 0.08          & 82.27 ± 0.03          & 82.39 ± 0.13          & 82.33 ± 0.16          \\ \cmidrule(l){2-7} 
%  & no TFIDF+ no PIFA  & 74.16 ± 0.22 & 80.70 ± 0.51 & 81.90 ± 0.15 & 81.65 ± 0.31 & 81.63 ± 0.28 \\
%  & no TFIDF+PIFA      & 78.91 ± 0.28 & 81.54 ± 0.14 & 82.10 ± 0.11 & 82.28 ± 0.16 & 82.22 ± 0.15 \\
%  & TFIDF+no PIFA      & 79.37 ± 0.15 & 83.83 ± 0.14 & 84.36 ± 0.14 & 84.94 ± 0.16 & 85.01 ± 0.10 \\
%                              & GIANT-XRT & \textbf{79.82 ± 0.07} & \textbf{84.40 ± 0.17} & \textbf{84.83 ± 0.32} & \textbf{85.39 ± 0.28} & \textbf{85.47 ± 0.29} \\ \bottomrule
% \end{tabular}
% \end{table}
...
% We first state the formal version of our Theorem.
% \begin{theorem}[Formal version of Theorem~\ref{thm:main}]
% 	Under the setting of cSBM and Assumption~\ref{ass:1}, the effect size of centroid for node feature $\mathbf{X}$ is $\frac{r}{\sigma} = \Theta(1)$. Moreover, the effect size of centroid for PIFA embedding $\mathbf{Z}$ is $\omega(1)$ condition on a high probability event $B_1\cap B_2$, where $\mathbb{P}(B_1\cap B_2)$ is at least $1-O(\frac{1}{n^c})$ for some constant $c>0$. 
% \end{theorem}
...
% \begin{table}[t!]
% \caption{Basic statistics for benchmark datasets.}
% \label{tab:data-stats}
% \centering
% \resizebox{\columnwidth}{!}{%
% \begin{tabular}{@{}lrrccc@{}}
...
% ogbn-arxiv      &     169,343 &     1,166,243 & 13.7 & 54/18/28 & Accuracy        \\
% ogbn-products   &   2,449,029 &    61,859,140 & 50.5 &   8/2/90 & Accuracy        \\
% ogbn-papers100M & 111,059,956 & 1,615,685,872 & 50.5 & 78/8/14 & Accuracy        \\
%     \bottomrule
% \end{tabular}%
% }
% \end{table}
...
%For the hyperparameters of XR-Transformer, we set most of them the same as in~\cite{jiong2021fast}. We only change the max training steps (denoted as \emph{max-steps}), number of branches for each intermediate node in hierarchical clustering (denoted as \emph{nr-split}), the number of nodes in the first level (denoted as \emph{min-codes}) and the maximum number of nodes at the last level that we train the matcher (denoted as \emph{max-match-clusters}).
%See files ``xrtransformer\_SSL\_ogbnarxiv.sh'' and ``xrtransformer\_SSL\_ogbnproducts.sh'' in our supplementary material for the exact choice of all hyperparameters.
%To generate numerical node features from trained XR-Transformer, we also need to decide the level for which we take the encoder from. This is decided by the validation accuracy of downstream MLP.
...
\begin{table*}[h]
    ...
    \begin{tabular}{l|rrrrrrr}
        \toprule
        Dataset         & $HLT$                     & $lr_{max}$        & $n_{step}$ & $B$ & $NS$        & $D$ \\
        \midrule
        ogbn-arxiv      &   32-128-512-2048         & $6\times 10^{-5}$ &   2,000    & 256 & $TFN$+$MAN$ & 4   \\
        ogbn-products   &  128-512-2048-8192-32768  & $6\times 10^{-5}$ &  10,000    & 256 & $TFN$+$MAN$ & 2   \\
        ogbn-papers100M &  128-2048-32768           & $6\times 10^{-5}$ & 100,000    & 512 & $TFN$       & 3   \\
    \bottomrule
    \end{tabular}
    }
\end{table*}
