...
\newcommand{\threads}[1]{\mathsf{Threads}_{#1}}
...
\newcommand{\acrl}{\mathtt{ar}}
\newcommand{\lk}{\ell}
\newcommand{\ev}[1]{\langle #1\rangle}
\newcommand{\tr}{\sigma}

\newcommand{\ord}[2]{\leq^{#1}_{\mathsf{#2}}}
\newcommand{\sord}[2]{<^{#1}_{\mathsf{#2}}}
\newcommand{\trord}[1]{\ord{#1}{tr}}
\newcommand{\stricttrord}[1]{\sord{#1}{tr}}
\newcommand{\hb}[1]{\ord{#1}{HB}}
\newcommand{\shb}[1]{\ord{#1}{SHB}}
\newcommand{\strictshb}[1]{\sord{#1}{SHB}}
\newcommand{\tho}[1]{\ord{#1}{TO}}

% \newcommand{\setreq}[3]{S_{\strictshb{#1}}^{#2,#3}}
\newcommand{\setreq}{S^\tr_{(e_1,e_2)}}
\newcommand{\preone}{A^\tr_{e_1}}
\newcommand{\pretwo}{A^\tr_{e_2}}

\newcommand{\ltho}[1]{\mathsf{pred}_{#1}}
\newcommand{\lw}[1]{\mathsf{lastWr}_{#1}}
\newcommand{\proj}[2]{#1|_{#2}}
% \newcommand{\tool}{{\textsc{TrueRacer}}}
\newcommand{\tool}{{\textsc{Rapid}}}
\newcommand{\rvpredict}{$\mathsf{RVPredict}$}
...
\newcommand{\WALR}{\mathbb{FWALR}}

\newcommand{\bev}[1] {[b_{#1}]}
\newcommand{\cev}[2] {[c_{#1}]^{#2}}
...
% \newcommand{\ucomment}[1]{}

% Drawing executions. Arguments: # of threads, and execution. 
\newcommand{\execution}[2]{\begin{tikzpicture}%
                             \foreach \x in {1,...,#1}
                               \node[right] at (2*\x+0.5,0.25) {$t_{\x}$};
                             \draw (1.9,0) -- (#1*2+1.6,0);%
                             \pgfmathsetmacro{\y}{1};%
                             #2%
                             \draw (1.9,0) -- (1.9,-0.4*\y);%
                             \draw (#1*2+1.6,0) -- (#1*2+1.6,-0.4*\y);%
                             \foreach \x in {2,...,#1}
                               \draw (2*\x-0.3,0) -- (2*\x-0.3,-0.4*\y);%
                             \draw (1.9,-0.4*\y) -- (#1*2+1.6,-0.4*\y);%
                           \end{tikzpicture}}

% \figev arguments: thread id, event, variable/lock
\newcommand{\figev}[2]{\node [left] at (1.75,-0.4*\y)  {\pgfmathprintnumber{\y}};%
                    \node [right] at (#1*2 + 0.3,-0.4*\y) {$ #2 $};%
