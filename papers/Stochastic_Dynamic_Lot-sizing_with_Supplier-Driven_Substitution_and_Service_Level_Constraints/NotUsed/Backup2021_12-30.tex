...
%&  I_{ t_n \ka} - B_{ t_n \ka} = \hat{v}_{t_n-1 , \ka} - \sum_{j\in C_{k}} {S}_{\ti_n \ka \jey} + \sum_{j\in P_{k}} {S}_{\ti_n  \jey \ka}  - \hat{D}_{n \ka} \quad &\forall \ka \in \Ka  &     \label{eq:Det_inventory_tn}&\\
%& v_{ t_n \ka} = I_{ t_n \ka} + x_{ t_n \ka}  \quad &\forall \ka \in \Ka  &     \label{eq:Det_inventoryPos_tn}& \\
%&  I_{\ti \ka} - B_{\ti \ka} = v_{k,t-1} - \sum_{j\in C_{k}} {S}_{\ti \ka \jey} + \sum_{j\in P_{k}} {S}_{\ti \jey \ka}  - E_{|n}[\overline{D}_{\ti \ka}] \quad &\forall t \ \in T, t > t_{n},\forall \ka \in \Ka  &     \label{eq:Dyn_F_Sub_ST_Service}&\\
